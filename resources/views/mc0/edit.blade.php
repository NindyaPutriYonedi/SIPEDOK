...
<h2 class="fw-bold mb-4">Edit Data MC0</h2>

<div class="card border-0 shadow-sm rounded-4">

<div class="card-body">

    <form action="/mc0/{{ $data->id }}"
          method="POST"
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <select name="status_digitasi"
                    ...
                    <option value="Belum Digitasi"
                        {{ $data->status_digitasi == 'Belum Digitasi' ? 'selected' : '' }}>
                        Belum Digitasi
                    </option>

                    <option value="Sudah Digitasi"
                        {{ $data->status_digitasi == 'Sudah Digitasi' ? 'selected' : '' }}>
                        Sudah Digitasi
                    </option>
            ...
            <div class="col-md-6 mb-3">
                <label>Tanggal Digitasi</label>
                <input type="date"
                       name="tanggal_digitasi"
                       value="{{ $data->tanggal_digitasi }}"
                       class="form-control">
            </div>
